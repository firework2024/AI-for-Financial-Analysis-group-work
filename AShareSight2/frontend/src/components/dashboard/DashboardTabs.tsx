  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      <Tabs
        ...
        listClassName="flex items-end gap-0 border-b border-ash-border bg-ash-card px-5 overflow-x-auto scrollbar-hide shrink-0 max-lg:px-3"
        buttonClassName="px-4 py-2.5 text-sm font-medium transition-colors whitespace-nowrap border-b-2 border-transparent"
        activeClassName="text-ash-primary border-ash-primary"
        inactiveClassName="text-ash-muted hover:text-ash-text"
      />
