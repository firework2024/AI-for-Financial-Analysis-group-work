...
export function PeersTab() {
  ...
  if (!dashboardData) {
    return (
      <div className="flex items-center justify-center h-64 text-ash-muted text-sm">
        暂无数据，请先选择资产
      </div>
    );
  }
  ...
  if (peers.length === 0 && !peerData) {
    return (
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center h-48 text-ash-muted text-sm">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-ash-card border border-ash-border rounded-lg p-4">
        <h4 className="text-sm font-semibold text-ash-text mb-3">详细对比</h4>
