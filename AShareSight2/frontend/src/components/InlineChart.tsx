  ...
  return {
    ...
    tooltip: {
      ...
      formatter: (params: any) => {
        ...
        return `${point.axisValue}<br/>Return: <span style="color: ${point.value >= 0 ? chartTheme.danger : chartTheme.success}">${sign}${point.value.toFixed(2)}%</span>`;
      },
    },
...
export const InlineChart: React.FC<InlineChartProps> = ({
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-4 text-ash-muted">
  ...
  return (
    <div className="my-4 p-4 bg-ash-panel rounded-lg border border-ash-border">
      <div className="text-xs text-ash-muted mb-2">
