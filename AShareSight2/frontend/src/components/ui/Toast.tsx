...
const typeStyles: Record<ToastType, { accent: string; icon: string }> = {
  success: {
    ...
    icon: 'text-ash-success',
  },
  error: {
    accent: 'border-l-red-500',
    icon: 'text-ash-danger',
  },
  warning: {
    accent: 'border-l-amber-500',
    icon: 'text-ash-warning',
  },
  info: {
    accent: 'border-l-blue-500',
    icon: 'text-ash-primary',
  },
};
  ...
  return (
    <div
      ...
      className={`
        ...
        bg-ash-card border border-ash-border rounded-lg
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-medium text-ash-text leading-snug">
          {item.title}
        </p>
        {item.message && (
          <p className="mt-0.5 text-2xs text-ash-text-secondary leading-relaxed">
            {item.message}
          </p>
        )}
      </div>
      ...
      <button
        ...
        className="
          ...
          focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ash-primary/50
        "
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
