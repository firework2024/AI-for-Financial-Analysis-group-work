...
export const ChatInput: React.FC<ChatInputProps> = ({ onDashboardRequest: _onDashboardRequest }) => {
  ...
  return (
    <div className="p-4 bg-ash-bg border-t border-ash-border">
      ...
      <div className="relative flex items-end max-w-5xl mx-auto">
        <textarea
          ...
          aria-label="输入聊天消息"
          rows={1}
          className="w-full bg-ash-panel text-ash-text border border-ash-border rounded-xl py-3 pl-4 pr-28 focus:outline-none focus:ring-2 focus:ring-ash-primary/50 focus:border-ash-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed placeholder-ash-muted resize-none overflow-y-hidden max-h-[160px]"
        />
        ...
        <div className="absolute right-2 flex items-center gap-2">
          {isChatLoading ? (
            <button
              ...
              aria-label="停止生成"
              className="p-2 bg-ash-danger text-white rounded-lg hover:bg-red-600 transition-colors"
              title="停止生成"
            >
            ...
            <button
              ...
              className="p-2 bg-ash-primary text-white rounded-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      ...
      <div className="text-center mt-2">
        ...
        <div className="mt-2 flex justify-center gap-2 text-[11px] text-ash-muted">
          <button
            className="px-2 py-1 rounded border border-ash-border hover:border-ash-primary transition-colors"
