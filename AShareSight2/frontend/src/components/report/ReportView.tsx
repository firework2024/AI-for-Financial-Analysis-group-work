...
export const ReportView: React.FC<ReportViewProps> = ({ report }) => {
  ...
  return (
    <div className="bg-white/90 dark:bg-ash-panel/90 rounded-2xl shadow-[0_10px_30px_-18px_rgba(15,23,42,0.45)] border border-slate-200/80 dark:border-slate-700/70 overflow-hidden max-w-4xl mx-auto my-4 relative">
      {/* Fullscreen button */}
      <button
      ...
      <div className="px-6 py-4 bg-slate-50 dark:bg-slate-900/80 border-t border-slate-200/80 dark:border-slate-700/70 flex flex-wrap items-center justify-between gap-3 text-[11px] text-slate-500 dark:text-slate-400">
        <span>Generated by AShareSight ? Deep Research Engine</span>
