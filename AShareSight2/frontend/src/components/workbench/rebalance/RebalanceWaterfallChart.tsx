...
export function RebalanceWaterfallChart({ actions }: RebalanceWaterfallChartProps) {
  ...
  return (
    <div className="p-3 bg-ash-card/50 rounded-lg border border-ash-border/50">
      <div className="text-xs font-medium text-ash-muted mb-2">权重变化可视化</div>
      <ReactECharts
        option={option}
        ...
        lazyUpdate
      />
      <div className="flex items-center gap-4 mt-2 text-2xs text-ash-muted">
