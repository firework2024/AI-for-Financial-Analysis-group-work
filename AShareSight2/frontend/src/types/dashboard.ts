...
export const STORAGE_KEYS = {
  ACTIVE_ASSET: 'asharesight_dashboard_active_v1',
  WATCHLIST: 'asharesight_dashboard_watchlist_v1',
  LAYOUT: 'asharesight_dashboard_layout_v1',
  NEWS_MODE: 'asharesight_dashboard_news_mode_v1',
  NEWS_SUB_TAB: 'asharesight_dashboard_news_sub_tab_v1',
  NEWS_TAG_FILTER: 'asharesight_dashboard_news_tag_filter_v1',
  NEWS_TIME_RANGE: 'asharesight_dashboard_news_time_range_v1',
  DEEP_ANALYSIS_INCLUDE_DEEPSEARCH: 'asharesight_dashboard_deep_analysis_include_deepsearch_v1',
} as const;
