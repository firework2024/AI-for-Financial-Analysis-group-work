"""CN/HK market data via Eastmoney API — used as fallback when rqdatac is unavailable.

Primary data source is rqdatac (see rqdata_price.py, rqdata_financial.py).
This module serves as the eastmoney fallback for A-share data.
Note: HK market support is deprecated (removed in AShareSight).
"""
...
def detect_market(ticker: str) -> str:
    ...
    if symbol.endswith((".SS", ".SZ", ".BJ")):
        return "CN"
    # HK support kept for legacy compatibility, unused in AShareSight
