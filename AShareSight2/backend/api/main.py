...
_SUPABASE_AUTH_CONFIGURED = False


def _is_supabase_auth_configured() -> bool:
    return _SUPABASE_AUTH_CONFIGURED
...
async def lifespan(app: FastAPI):
    ...
    # RAG observability removed in AShareSight
    logger.info("[RAG] RAG observability disabled (AShareSight)")
...
app = FastAPI(
    ...
    description="AShareSight - A股智能金融分析平台",
    version="1.0.0",
    lifespan=lifespan,
)
