...
DEFAULT_WATCHLIST = [
    WatchItem(symbol="600519.XSHG", type="equity", name="贵州茅台"),
    WatchItem(symbol="300750.XSHE", type="equity", name="宁德时代"),
    WatchItem(symbol="600036.XSHG", type="equity", name="招商银行"),
    WatchItem(symbol="000858.XSHE", type="equity", name="五粮液"),
    WatchItem(symbol="601318.XSHG", type="equity", name="中国平安"),
    WatchItem(symbol="000001.XSHG", type="index", name="上证指数"),
    WatchItem(symbol="000300.XSHG", type="index", name="沪深300"),
]
