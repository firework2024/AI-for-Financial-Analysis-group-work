...
# Stubs for removed tools (RAG/US/Option sources)
def _stub_not_available(*args, **kwargs):
    return {"error": "tool_not_available", "message": "This tool has been removed in AShareSight (RAG/US/Option sources no longer supported)"}

_stub_not_available.__doc__ = "Stub for removed tool"

_analyze_historical_drawdowns = _stub_not_available
_get_current_datetime = _stub_not_available
_get_economic_events = _stub_not_available
_get_market_sentiment = _stub_not_available
_get_authoritative_media_news = _stub_not_available
_get_earnings_call_transcripts = _stub_not_available
_get_eps_revisions = _stub_not_available
_get_event_calendar = _stub_not_available
_get_official_macro_releases = _stub_not_available
_get_local_market_filings = _stub_not_available
_get_option_chain_metrics = _stub_not_available
_get_sec_filings = _stub_not_available
_get_sec_company_facts_quarterly = _stub_not_available
_get_sec_material_events = _stub_not_available
_get_sec_risk_factors = _stub_not_available
_run_portfolio_stress_test = _stub_not_available
_score_news_source_reliability = _stub_not_available
_get_fred_data = _stub_not_available
...
def get_company_news(ticker: str, limit: int = 5, fast: bool = False) -> str:
    ...
    try:
        news = _get_company_news(ticker, max_results=limit)
